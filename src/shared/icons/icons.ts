...
import { BatteryChargingIcon } from '@phosphor-icons/react/dist/csr/BatteryCharging';
import { BatteryFullIcon } from '@phosphor-icons/react/dist/csr/BatteryFull';
...
import { ParkIcon } from '@phosphor-icons/react/dist/csr/Park';
...
import { TireIcon } from '@phosphor-icons/react/dist/csr/Tire';
import { ToggleLeftIcon } from '@phosphor-icons/react/dist/csr/ToggleLeft';
import { ToggleRightIcon } from '@phosphor-icons/react/dist/csr/ToggleRight';
...
export const Icons = {
  ...
  mailWarning: EnvelopeSimpleIcon,
  circleQuestionMark: QuestionIcon,
  ...
  filePenLine: NotePencilIcon,
  signpost: SignpostIcon,
  ticketCheck: TicketIcon,
  squareParking: ParkIcon,
  gavel: GavelIcon,
  plug: PlugIcon,
  evCharger: ChargingStationIcon,
  disc2: TireIcon,
  timeline: ClockCounterClockwiseIcon,

  // Documents & Files
  fileText: FileTextIcon,
  file: FileIcon,
  filePlus: FilePlusIcon,
  fileCheck: ChecksIcon,
  fileX: FileXIcon,
  folder: FolderIcon,
  ...
  laptop: LaptopIcon,
  caseSensitive: TextAaIcon,
  leaf: LeafIcon,
  badgeDollarSign: CurrencyCircleDollarIcon,
  landmark: BankIcon,
  coins: CoinsIcon,
