...
export const BODY_TYPE_CONFIG: EntityOption<BodyType>[] = [
  {
    ...
    label: `vehicle.bodyType.${BODY_TYPE.SEDAN}`,
    icon: 'car',
    color: 'blue',
  },
  {
    ...
    label: `vehicle.bodyType.${BODY_TYPE.HATCHBACK}`,
    icon: 'car',
    color: 'blue',
  },
  {
    ...
    label: `vehicle.bodyType.${BODY_TYPE.WAGON}`,
    icon: 'car',
    color: 'blue',
  },
  {
    id: '4',
    value: BODY_TYPE.SUV,
    label: `vehicle.bodyType.${BODY_TYPE.SUV}`,
    icon: 'car',
    color: 'green',
  },
  {
    ...
    label: `vehicle.bodyType.${BODY_TYPE.CROSSOVER}`,
    icon: 'car',
    color: 'teal',
  },
  {
    ...
    label: `vehicle.bodyType.${BODY_TYPE.COUPE}`,
    icon: 'car',
    color: 'violet',
  },
  {
    ...
    label: `vehicle.bodyType.${BODY_TYPE.CONVERTIBLE}`,
    icon: 'car',
    color: 'pink',
  },
  {
    ...
    label: `vehicle.bodyType.${BODY_TYPE.MINIVAN}`,
    icon: 'car',
    color: 'amber',
  },
  {
    ...
    label: `vehicle.bodyType.${BODY_TYPE.PICKUP}`,
    icon: 'car',
    color: 'orange',
  },
  {
    id: '10',
    value: BODY_TYPE.VAN,
    label: `vehicle.bodyType.${BODY_TYPE.VAN}`,
    icon: 'car',
    color: 'gray',
  },
  {
    ...
    label: `vehicle.bodyType.${BODY_TYPE.OTHER}`,
    icon: 'car',
    color: 'gray',
  },
];
...
export const TRANSMISSION_CONFIG: EntityOption<Transmission>[] = [
  {
    ...
    label: `vehicle.transmission.${TRANSMISSION.MANUAL}`,
    icon: 'cog',
    color: 'blue',
  },
  {
    ...
    label: `vehicle.transmission.${TRANSMISSION.AUTOMATIC}`,
    icon: 'cog',
    color: 'green',
  },
  {
    ...
    label: `vehicle.transmission.${TRANSMISSION.ROBOTIC}`,
    icon: 'cog',
    color: 'violet',
  },
];
...
export const DRIVE_TYPE_CONFIG: EntityOption<DriveType>[] = [
  {
    ...
    label: `vehicle.driveType.${DRIVE_TYPE.FWD}`,
    icon: 'car',
    color: 'blue',
  },
  {
    ...
    label: `vehicle.driveType.${DRIVE_TYPE.RWD}`,
    icon: 'car',
    color: 'orange',
  },
  {
    ...
    label: `vehicle.driveType.${DRIVE_TYPE.AWD}`,
    icon: 'car',
    color: 'green',
  },
];
